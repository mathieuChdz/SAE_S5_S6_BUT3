window.onload = function () {
  ...
  const popup_settings = document.getElementsByClassName("settings-popup");
  ...
  for (let popup_item = 0; popup_item < popup_settings.length; popup_item++) {
    popup_settings[popup_item].getElementsByClassName("material-symbols-outlined")[0].addEventListener('click', (event) => {
      popup_settings_open(popup_settings[popup_item]);
    });
  }
  ...
  function popup_open(id) {
    ...
    /**
     * Permet l'ouverture de la popup settings
     * 
     * @return {void}
     */
  function popup_settings_open(id) {
  
    const nav = document.getElementsByTagName('nav')
    const popup_div = document.getElementById("settings-popup-content");
    const popup_div_item = document.getElementById("settings-popup-content-item");
    const popup_titre = popup_div.getElementsByTagName("h1")[0];
    const popup_content = popup_div.getElementsByTagName("p")[0];
    const popup_div_list = document.getElementsByClassName("content-item-p");
    const html = document.getElementsByTagName("html");
