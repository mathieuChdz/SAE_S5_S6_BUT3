...
def main():
    ...
    if my_rank == 0:
        ...
        total_points_inside_quarter_circle = np.sum(results.flatten()) / len(results.flatten())

        total_points = nbr_echantillons * cluster_size
        estimated_pi = 4 * (total_points_inside_quarter_circle / total_points)
        print(estimated_pi)
